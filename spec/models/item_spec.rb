...
RSpec.describe "Itemモデルのテスト", type: :model do
  describe "バリデーションのテスト" do
    ...
    context "nameカラム" do
      it "空でないこと", spec_category: "バリデーションの確認" do
        item.name = ''
